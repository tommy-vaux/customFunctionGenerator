// this file contains all lookup tables for waves - including multiple resolutions so that it can handle higher frequencies

static int sine[] = { // 120 values
...
static int triangle[] { // 120 values
...
static int sawtooth[] { // 120 values
